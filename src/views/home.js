...
const Home = (props) => {
  return (
    <div className="home-container">
      <Helmet>
        <title>Granular Half Tarsier</title>
        <meta property="og:title" content="Granular Half Tarsier" />
      </Helmet>
      ...
      <div className="home-hero">
        <div className="home-container2">
          <h1 className="home-text">
            Magnificents++--??#####??!!!things are very simple
          </h1>
      ...
      <footer className="home-footer">
        <div className="home-container3">
          ...
          <nav className="home-nav2">
            ...
            <span className="home-text10">Features</span>
            <span className="home-text11">Pricing</span>
            <span className="home-text12">Team</span>
